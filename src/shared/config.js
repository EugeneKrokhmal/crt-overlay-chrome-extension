...
export const STORAGE_KEYS = {
  ...
  GLITCH_TRACKING_LEVEL: "glitchTrackingLevel",
  GLITCH_WOBBLE_LEVEL: "glitchWobbleLevel",
  GLITCH_HEADSWITCH_LEVEL: "glitchHeadswitchLevel",
  GLITCH_RGB_LEVEL: "glitchRgbLevel",
  GLITCH_DROPOUT_LEVEL: "glitchDropoutLevel",
};
...
export const DEFAULT_OPTIONS = {
  ...
  [STORAGE_KEYS.GLITCH_TRACKING_LEVEL]: 0.5,
  [STORAGE_KEYS.GLITCH_WOBBLE_LEVEL]: 0.3,
  [STORAGE_KEYS.GLITCH_HEADSWITCH_LEVEL]: 0.25,
  [STORAGE_KEYS.GLITCH_RGB_LEVEL]: 0.35,
  [STORAGE_KEYS.GLITCH_DROPOUT_LEVEL]: 0.2,
};
...
export const STORAGE_KEYS_LIST = [
  ...
  STORAGE_KEYS.GLITCH_TRACKING_LEVEL,
  STORAGE_KEYS.GLITCH_WOBBLE_LEVEL,
  STORAGE_KEYS.GLITCH_HEADSWITCH_LEVEL,
  STORAGE_KEYS.GLITCH_RGB_LEVEL,
  STORAGE_KEYS.GLITCH_DROPOUT_LEVEL,
];
